      ...
      <div className="p-5 space-y-5">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-2 mt-1.5">
              <StarRating rating={Math.round(member.rating)} size={14} />
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-aura-surface2 dark:bg-aura-dark-surface2 rounded-xl p-3 text-center">
            <p className="text-xl font-bold text-aura-text dark:text-aura-dark-text">{member.experience}+</p>
            <p className="text-xs text-aura-muted dark:text-aura-dark-muted">Years Experience</p>
          </div>
          <div className="bg-aura-surface2 dark:bg-aura-dark-surface2 rounded-xl p-3 text-center">
            <p className="text-xl font-bold text-aura-text dark:text-aura-dark-text">{member.reviews}</p>
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            {member.specialties.map((s) => (
              <span key={s} className="px-3 py-1 bg-aura-green dark:bg-aura-dark-surface2 text-aura-text dark:text-aura-dark-text text-xs rounded-full">
                {s}
              </span>
            ))}
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
          <div className="bg-aura-surface2 dark:bg-aura-dark-surface2 rounded-xl p-3">
            ...
            <p className="text-aura-text dark:text-aura-dark-text">{member.workingDays.join(', ')}</p>
          </div>
          <div className="bg-aura-surface2 dark:bg-aura-dark-surface2 rounded-xl p-3">
            ...
            <p className="text-aura-text dark:text-aura-dark-text">{member.workingHours}</p>
          </div>
        </div>
              ...
              >
                ...
                <div className="flex flex-wrap gap-1.5 mb-4">
                  {member.specialties.slice(0, 3).map((s) => (
                    <span key={s} className="px-2.5 py-0.5 bg-aura-surface2 dark:bg-aura-dark-surface2 text-aura-muted dark:text-aura-dark-muted text-xs rounded-full">
                      {s}
                    </span>
                  ))}
                </div>
